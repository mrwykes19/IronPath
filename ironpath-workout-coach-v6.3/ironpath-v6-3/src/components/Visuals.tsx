...
const runnerAsset = require('../../assets/characters/run.png');
const phaseAssets = {
...
const noWorkoutAsset = require('../../assets/v62/no_workout.png');
...
export const ActivityGraphic = ({ device, active = false, size = 38 }: { device: CardioDevice; active?: boolean; size?: number }) => {
  if (device === 'treadmill-run' || device === 'treadmill-walk') {
    return (
      <View style={[styles.activityImageWrap, active && styles.activityWrapActive, { width: size, height: size }]}>
        <Image source={runnerAsset} resizeMode="contain" style={styles.activityImage} />
      </View>
    );
  }
  const scale = size / 38;
...
const metricAssets = {
  volume: require('../../assets/v62/metric_volume.png'),
  workouts: require('../../assets/v62/metric_workouts.png'),
  calories: require('../../assets/v62/metric_calories.png'),
  streak: require('../../assets/v62/metric_streak.png')
} as const;
...
const styles = StyleSheet.create({
  ...
  activityImage: { width: '112%', height: '112%' },
  ...
  metricAssetImage: { width: '100%', height: '100%' },
  ...
  emptyGraphicWorkout: { width: 280, height: 165, borderRadius: 22, backgroundColor: 'transparent', borderWidth: 0 },
