    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <Card>
        ...
        <View style={styles.fieldRow}>
          ...
          <View style={styles.field}><Text style={styles.label}>Calories burned</Text><TextInput value={(state.profile.weeklyCalorieGoal ?? 1500).toString()} onChangeText={(value) => updateProfile({ weeklyCalorieGoal: Math.max(100, Number(value) || 100) })} keyboardType="number-pad" style={styles.input} /></View>
        </View>
        <View style={styles.fieldRow}>
        ...
        <Text style={styles.planHint}>Cardio days count distinct days with a completed cardio session. Active minutes combine lifting and cardio time.</Text>
      </Card>
