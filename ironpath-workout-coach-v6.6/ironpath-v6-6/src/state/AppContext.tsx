...
import { calculateVolume, createCustomWorkoutSession, createWorkoutSession, estimateCalories } from '../engine/planner';
    ...
    finishWorkout: (manualCalories) => {
      ...
      setState((current) => ({
        ...
        nextTemplateIndex: completed.isCustom
          ...
          : (current.nextTemplateIndex + 1) % getProgramForGoal(current.profile.goal, current.profile.trainingDays).length,
