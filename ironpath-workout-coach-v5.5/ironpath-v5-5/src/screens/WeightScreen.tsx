  ...
  return (
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <Card style={styles.heroCard}>
        ...
        {normalizedValues.length ? <TrendBars values={normalizedValues} labels={latest.map((entry) => new Date(entry.date).toLocaleDateString(undefined, { month: 'numeric', day: 'numeric' }))} /> : <Text style={styles.empty}>Add your first weigh-in to begin the chart.</Text>}
      </Card>
