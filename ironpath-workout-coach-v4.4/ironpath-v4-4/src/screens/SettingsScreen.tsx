...
export const SettingsScreen = () => {
  const { state, updateProfile, setHealthKitConnected, markBackupCreated, restoreBackup, resetAllData, generatePlan, updatePlannedWorkout, updatePlannedExercise, movePlannedExercise, removePlannedExercise, addPlannedExercise, toggleExerciseLock } = useApp();
      ...
      <Card style={styles.evolutionCard}>
        <View style={styles.goalHeading}>
          <View style={styles.flex}>
            ...
            <Text style={styles.cardTitle}>My Training Week</Text>
            <Text style={styles.copy}>IronPath plans a four-week block, keeps productive lifts long enough to measure progress, and rotates exercises when variety or a plateau makes the change useful.</Text>
          </View>
          <View style={styles.weekBadge}><Text style={styles.weekBadgeText}>WEEK {state.weeklyPlan?.blockWeek ?? 1}/4</Text></View>
        </View>
        ...
        <View style={styles.weekActions}>
          <PrimaryButton title="Generate this week" onPress={() => generatePlan()} style={styles.flexButton} />
        </View>
        ...
        <Text style={styles.copy}>Completed workouts are never rewritten. Your current active workout also stays unchanged. Locked exercises remain in future generated weeks.</Text>
      </Card>
