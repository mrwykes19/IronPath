      ...
      <Pressable onPress={() => setShowPreview(true)} style={({ pressed }) => [styles.workoutPressable, pressed && styles.workoutPressed]}>
        <Card style={styles.workoutCard}>
          ...
          <View style={styles.metaRow}>
            ...
            <View style={styles.metaDivider} />
            <View style={styles.sequenceChip}><Text style={styles.sequenceText}>{state.activeSession ? 'In progress' : 'Tap to preview'}</Text></View>
          </View>
        </Card>
      </Pressable>
        ...
        <View style={styles.modalBackdrop}>
          ...
          <View style={styles.previewSheet}>
                ...
                return (
                  <View key={`${item.exerciseId}-${index}`} style={styles.previewExercise}>
                    ...
                    <View style={styles.previewWeight}>
                      ...
                      <Text style={styles.previewWeightValue}>{recommendation.weight} {state.profile.unit}</Text>
                    </View>
                  </View>
                );
              })}
            ...
            <View style={styles.previewFooter}>
              <Text style={styles.previewFooterText}>{template?.exercises.length ?? 0} exercises · about {template?.estimatedMinutes ?? 60} minutes</Text>
              <PrimaryButton
...
const styles = StyleSheet.create({
  ...
  previewCueText: { color: colors.accent, fontSize: 7, fontWeight: '900', letterSpacing: 0.8 },
  ...
  previewExercise: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: colors.panel, borderWidth: 1, borderColor: colors.border, borderRadius: 16, padding: 11 },
