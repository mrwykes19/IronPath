      ...
      <Card style={styles.heroCard}>
        ...
        {normalizedValues.length ? (
          ...
          <View style={styles.emptyScene}>
            <Image source={require('../../assets/v74/weight_empty.png')} resizeMode="contain" style={styles.emptyWeightImage} />
...
const styles = StyleSheet.create({
  ...
  emptyScene: { alignItems: 'center', justifyContent: 'flex-end', paddingTop: 10, paddingBottom: 4, minHeight: 380 },
  emptyWeightImage: { width: 292, height: 332, marginTop: 4, marginBottom: 2, opacity: 0.98 },
  empty: { color: colors.text, textAlign: 'center', paddingTop: 6, fontSize: 15, fontWeight: '800' },
  emptyHint: { color: colors.muted, textAlign: 'center', fontSize: 11, lineHeight: 16, marginTop: 6, paddingHorizontal: 12 },
