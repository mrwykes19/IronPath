...
export const HistoryScreen = ({ goBack }: { goBack: () => void }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.content}>
      ...
      }) : <Card style={styles.emptyCard}><EmptyStateGraphic kind="history" /><Text style={styles.empty}>Complete a workout and it will appear here.</Text></Card>}
    </ScrollView>
  );
};
...
const styles = StyleSheet.create({
  ...
  empty: { color: colors.muted, paddingVertical: 10, textAlign: 'center' }
});
