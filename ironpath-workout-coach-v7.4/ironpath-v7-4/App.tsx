...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: '#020306', ...(Platform.OS === 'web' ? ({ height: '100dvh' } as any) : null) },
  desktopBackdrop: { flex: 1, backgroundColor: '#020306', alignItems: 'center', ...(Platform.OS === 'web' ? ({ minHeight: '100dvh' } as any) : null) },
  desktopStage: {
    flex: 1,
    width: '100%',
  ...
  container: {
    ...
    overflow: 'hidden',
    ...(Platform.OS === 'web' ? ({ height: '100dvh', maxHeight: '100dvh' } as any) : null)
  },
  content: { flex: 1, paddingBottom: 78 },
  loading: { flex: 1, backgroundColor: colors.bg, alignItems: 'center', justifyContent: 'center' },
  nav: {
    position: 'absolute',
    left: 0,
    right: 0,
    bottom: Platform.OS === 'web' ? -1 : 0,
    height: 78,
