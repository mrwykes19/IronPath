...
const styles = StyleSheet.create({
  ...
  cardioStats: { flexDirection: 'row', gap: 7 },
  cardioStat: { flex: 1, minHeight: 62, borderRadius: 12, backgroundColor: colors.panelSoft, borderWidth: 1, borderColor: colors.border, padding: 9 },
