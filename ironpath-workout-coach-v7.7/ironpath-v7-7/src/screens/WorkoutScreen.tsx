      ...
      <View style={styles.emptyState}>
        <View style={styles.emptyHero}>
          ...
          <View style={styles.emptyOverlay}>
            ...
            <Text style={styles.emptyText}>Your next session is ready when you are.</Text>
          </View>
        </View>
      </View>
    );
...
const styles = StyleSheet.create({
  ...
  emptyState: { flex: 1, minHeight: 680, justifyContent: 'center', paddingHorizontal: 16, paddingTop: 18, paddingBottom: 108 },
  emptyIcon: { color: colors.accent, fontSize: 40 },
  emptyTitle: { color: colors.text, fontSize: 24, fontWeight: '900' },
  emptyText: { color: colors.muted, textAlign: 'center', fontSize: 11, lineHeight: 16, marginTop: 10 },
  emptyHero: { flex: 1, width: '100%', alignItems: 'stretch', justifyContent: 'center', position: 'relative' },
  emptyOverlay: { position: 'absolute', top: 24, left: 12, right: 12, alignItems: 'stretch' },
