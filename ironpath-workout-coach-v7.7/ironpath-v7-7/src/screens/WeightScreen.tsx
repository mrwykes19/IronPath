    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <Card style={styles.heroCard}>
        ...
        <View style={styles.chartScene}>
          <Image source={require('../../assets/v74/weight_empty_fade.png')} resizeMode="contain" style={styles.chartBackgroundImage} />
          {normalizedValues.length ? (
            ...
            <View style={styles.emptyOverlay}>
              ...
              <Text style={styles.emptyHint}>Your trend, 7-day average, and direction changes will show here.</Text>
            </View>
          )}
        </View>
      </Card>
...
const styles = StyleSheet.create({
  ...
  chartScene: { position: 'relative', minHeight: 330, justifyContent: 'flex-end', overflow: 'hidden', marginTop: 4 },
  chartBackgroundImage: { position: 'absolute', left: 0, right: 0, top: -14, width: '100%', height: 350, opacity: 0.22 },
  chartOverlay: { position: 'relative', zIndex: 2, minHeight: 250, justifyContent: 'flex-end', paddingTop: 78, paddingBottom: 8 },
  emptyOverlay: { position: 'relative', zIndex: 2, minHeight: 330, justifyContent: 'flex-end', alignItems: 'center', paddingBottom: 20 },
  empty: { color: colors.text, textAlign: 'center', paddingTop: 6, fontSize: 15, fontWeight: '800' },
  emptyHint: { color: colors.muted, textAlign: 'center', fontSize: 11, lineHeight: 16, marginTop: 4, paddingHorizontal: 14, opacity: 0.92 },
