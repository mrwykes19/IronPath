      ...
      <Card style={styles.heroCard}>
        ...
        {normalizedValues.length ? (
          ...
          <View style={styles.emptyScene}>
            <Image source={require('../../assets/v74/weight_empty_fade.png')} resizeMode="contain" style={styles.emptyWeightImage} />
...
const styles = StyleSheet.create({
  ...
  emptyScene: { alignItems: 'center', justifyContent: 'flex-end', paddingTop: 4, paddingBottom: 0, minHeight: 392 },
  emptyWeightImage: { width: 308, height: 350, marginTop: 2, marginBottom: -4, opacity: 0.9 },
