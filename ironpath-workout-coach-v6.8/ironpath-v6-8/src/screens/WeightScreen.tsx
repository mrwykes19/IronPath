  ...
  return (
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      <View style={styles.headingRow}>
        ...
        <View style={styles.headingGraphic}><Image source={require('../../assets/v64/weight.png')} resizeMode="contain" style={styles.headingGraphicImage} /></View>
      </View>
...
const styles = StyleSheet.create({
  ...
  headingGraphic: { width: 76, height: 72, borderRadius: 18, backgroundColor: '#07101A', borderWidth: 1, borderColor: colors.borderStrong, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  headingGraphicImage: { width: '94%', height: '94%' },
